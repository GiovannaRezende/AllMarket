...
export default function Index() {
    ...
    let lista1 = produtos.filter(p => p.id_categoria === 12);
    let lista2 = produtos.filter(p => p.id_categoria === 11);
        ...
        <Container>
            ...
            <div className="conteudo">
                <div className="container-banner">
                    <div className="banner"> <img src="./assets/images/Banner-Carnes.png" alt="" />
                    </div>
                </div>
                <div className="titulo2">Carnes</div>
