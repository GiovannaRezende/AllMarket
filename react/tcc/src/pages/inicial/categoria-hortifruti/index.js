...
export default function Index() {
    ...
    let lista1 = produtos.filter(p => p.id_categoria === 6);
    let lista2 = produtos.filter(p => p.id_categoria === 5);
        ...
        <Container>
            ...
            <div className="conteudo">
                <div className="container-banner">
                    <div className="banner"> <img src="./assets/images/Banner-Hortifruti.png" alt="" />
                    </div>
                </div>
                <div className="titulo2">Hortifruti</div>
